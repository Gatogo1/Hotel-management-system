...
<?php include('sidebar.php');
 if(isset($useroles)){  if(!in_array("rooms",$useroles)){
                                   ...
                                   while($row = $result->fetch_assoc()) { 
                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <td>
                                                  <?php if(isset($useroles)){  if(in_array("edit_room",$useroles)){ ?>
                                                  <a title="Edit" href="edit_room.php?id=<?=$row['id'];?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
                                                  <?php } } ?>
                                                  <?php if(isset($useroles)){  if(in_array("delete_room",$useroles)){ ?>
                                                  <a title="Delete" href="view_room.php?id=<?=$row['id'];?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                                  <?php } } ?>
                                                </td>
                                            </tr>
                                          <?php  $i++;} 
