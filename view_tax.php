                                   ...
                                   while($row = $result->fetch_assoc()) { 
                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <td>
                                                  <a title="Edit" href="edit_tax.php?id=<?=$row['id'];?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
                                                  <a title="Delete" href="view_tax.php?id=<?=$row['id'];?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                          <?php  $i++;} 
                                          ?>
