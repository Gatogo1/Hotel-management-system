        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">View Drinks Payments Report</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View Drinks Payments Report</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
                         ...
                         <input type="submit" name="show" class="btn btn-primary" value="Show"> 
                            ...
                            <div class="card-body">                               
                                <div class="table-responsive m-t-40">
                                    ...
                                    {
                                      extract($_POST);
                                      $sql = "SELECT * FROM `drinks_invoice` WHERE delete_status=0 and added_date>='".$from_date."' and added_date<='".$to_date."'";
                                    }
                                    else
                                    {
