...
{
    extract($_POST);
    $q1="UPDATE `plats` SET `category`='$category',`item_name`='$item_name',`price`='$price',`description`='$description',`status`='$status' WHERE `id`='".$_GET['id']."'";
    //$q2=$conn->query($q1);
...
?>
<?php
$que="SELECT * FROM `plats` WHERE id='".$_GET["id"]."'";
         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Edit Food</h3> </div>
