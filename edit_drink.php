...
{
    extract($_POST);
    $q1="UPDATE `drinks` SET `category`='$category',`item_name`='$item_name',`price`='$price',`description`='$description',`status`='$status' WHERE `id`='".$_GET['id']."'";
    //$q2=$conn->query($q1);
...
?>
<?php
$que="SELECT * FROM `drinks` WHERE id='".$_GET["id"]."'";
         ...
         <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Edit Drink</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Edit Drink</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->     
