    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card p-30" style="background: #3a4651;">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-address-card f-s-40 color-white"></i></span>
                                </div>
                                ...
                                $row=mysqli_fetch_array($res);?> 
                                    ...
                                    <p class="m-b-0 color-white">Total rooms</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card p-30" style="background: #8119c4;">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                ...
                                $row=mysqli_fetch_array($res);?> 
                                    <h2 class="color-white"><?php echo $row[0];?></h2>
                                    <p class="m-b-0 color-white">total customers</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card p-30" style="background: #c44c4d;">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                ...
                                $row=mysqli_fetch_array($res);?> 
                                    <h2 class="color-white"><?php echo $row[0];?></h2>
                                    <p class="m-b-0 color-white">total bookings</p>
                                </div>
                            </div>
                        </div>
                    </div>
