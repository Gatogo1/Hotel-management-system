...
session_start();
    ...
    $pdf->SetTitle('Food Payment Invoice ');  
    ...
    <tr style="background-color:#4c99d6;" align="center"><th width="5%"><b>Sr</b></th><th width="25%"><b>Food Name</b></th><th><b>Qty.</b></th><th><b>Rate</b></th><th><b>Total</b></th></tr>';
    $sql_items = "select * from plats_invoice_items where plats_invoice_id = '".$drink['id']."'";
    $res_items = $conn->query($sql_items);
    $i=0;
    while($item = mysqli_fetch_array($res_items)){
      $sql = "select *from plats where id = '".$item['plats_id']."'";
      $rep = $conn->query($sql);
