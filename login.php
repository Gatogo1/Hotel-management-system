                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                                <center><img src="uploadImage/Logo/<?php echo $row_login['login_logo'];?>" style="width:50%;"></center><br><h4><b>THE KAMB HOTEL MANAGEMENT SYSTEM</b></h4> 
                               <center> <mark><b>Advanced Version 2.0</b> </mark></center><br>
                                <form method="POST">
                                    ...
                                    <button type="submit" name="btn_login" class="btn btn-primary btn-flat m-b-30 m-t-30">Sign in</button><br><br>
