      ...
      ?>
        <tr>
          <!-- <td><?php echo $i;?></td> -->
            ...
            <td>
              <?php if($row['id']!=1){ ?>
                <a href="edit_roles.php?id=<?=$row['id'];?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
                <a href="view_roles.php?id=<?=$row['id'];?>"  class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
              <?php } ?>
            </td>
        </tr>
    <?php  $i++;} 
