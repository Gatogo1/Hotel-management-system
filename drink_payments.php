...
<?php
 if (isset($_POST['btn_add'])) {
  extract($_POST);
   $sql = "INSERT INTO `drinks_invoice_payments`( `drinks_invoice_id`,`amount`,`type`,`note`,`added_date`) VALUES ('$drinks_invoice_id','$amount','$type','$note','".date('Y-m-d')."')";

 if ($conn->query($sql) === TRUE) {
      $_SESSION['success']=' Record Successfully Added';
     ?>
<script type="text/javascript">
window.location="drink_payments.php?id=<?php echo $_GET['id']; ?>";
</script>
<?php
} else {
...
$que="SELECT SUM(amount) as paid FROM `drinks_invoice_payments` WHERE drinks_invoice_id='".$_GET["id"]."'";
$query=$conn->query($que);
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Drink Payments</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Drink Payments</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <form class="form-horizontal" method="POST" name="bookingreportform" enctype="multipart/form-data">
                  <input type="hidden" name="drinks_invoice_id" value="<?php echo $id; ?>">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    ...
                                    <?php 
                                    include 'connect.php';
                                      $sql = "SELECT * FROM `drinks_invoice_payments` WHERE drinks_invoice_id='".$_GET["id"]."'";
