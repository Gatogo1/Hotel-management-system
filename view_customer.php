...
if(isset($useroles)){  if(!in_array("customer",$useroles)){
                                      ...
                                      ?>
                                            <tr>
                                                ...
                                                <td>
                                                  ...
                                                  <a title="Edit" href="edit_customer.php?id=<?=$row['id'];?>"class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
                                                  <?php } } ?>
                                                  <?php if(isset($useroles)){  if(in_array("delete_customer",$useroles)){ ?> 
                                                  <a title="Delete" href="view_customer.php?id=<?=$row['id'];?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                                                  <?php } } ?>
                                                </td>
                                            </tr>
                                          <?php  $i++;} 
