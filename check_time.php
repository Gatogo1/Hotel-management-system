...
while($row=mysqli_fetch_array($query))
{
     ...
     $row3=$result3->fetch_assoc();
      $sql4 = "SELECT SUM(amount) as amt from tbl_payment WHERE bookingid='".$_GET["id"]."'";
                                    ...
                                    $sql5 = "SELECT * FROM `tbl_check` WHERE id='".$_GET['id']."'";
                                    $result5=$conn->query($sql5);
                                    $row5=$result5->fetch_assoc();
                                    $sql6 = "SELECT * FROM `tbl_check1` WHERE id='".$_GET['id']."'";
...
<br>
<br>
                        <form class="form-valide" action="pages/checkin.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-digits">ENTER CUSTORMER CHECK IN TIME<span class="text-danger">*</span></label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-digits" name="timein" placeholder="00:00"   >
                                            </div>
                                        </div>
